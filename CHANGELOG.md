...
- **Game save settings** — header button visibility updates immediately after Save.
...
- **App log file** — diagnostic log renamed from `scanner.log` to `wavetrace.log` (existing files are migrated on first access).
