...
Tier / Wave / Coin-min are the initial set. **Wave skips** shipped in v0.2.22–v0.2.23 (detection, charting, History analytics). Good next candidates are **stable, OCR-friendly** values:
